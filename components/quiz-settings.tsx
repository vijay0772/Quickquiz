...
const QuizSettings = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-4 md:gap-6">
      <h2 style={{
  color: 'white', 
  fontSize: '2rem', // Adjusted size for h2, you can change this as needed
  fontWeight: 'bold', 
  textAlign: 'center', 
 ...
 <Select value={category} onValueChange={(value) => setCategory(value)} >
        <SelectTrigger className="w-full md:max-w-xs xl:max-w-md" style={{color: 'lightblue'}}>
      ...
      <p className="text-xs lg:text-sm font-semibold" style={{
  color: 'white', 
  fontSize: '2rem', // Adjusted size for h2, you can change this as needed
  fontWeight: 'bold', 
  textAlign: 'center', 
