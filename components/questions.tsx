...
const Questions = ({ questions, limit, category }: Props) => {
  ...
  return (
    <div className="wrapper" style={{
      ...
      alignItems: 'center', 
      background: 'url("https://wallpapercave.com/wp/wp10480933.jpg") no-repeat center center fixed', // Background image set here
      backgroundSize: 'cover'
    }}>
     <div className="bg-white p-4 shadow-md w-full md:w-[80%] lg:w-[70%] max-w-5xl rounded-md" style={{ backgroundColor: 'rgba(255, 255, 255, 0.85)' }}> 
